...
## ✨ LLocal now supports Text to Speech

- Text to speech is here using `kokoro-82m`
- There's a horizontal dock to every message!
- You can branch off from a message and create a new chat!
- Specifically tables can be copied!

## 🌊 What's Changed

- Tables and Code block styling has been made more consistent
- The message dock consists of three buttons (Copy message, Text to Speech and Branch off)
- Specifically Tables can be copied (just the table markdown)

Thanks to @dandonarahul2002 for updating the documentation!

- Removing $ from readme to ease copy-pasting commands by @dandonarahul2002 in <https://github.com/kartikm7/llocal/pull/17>

**Full Changelog**: <https://github.com/kartikm7/llocal/compare/v1.0.0-beta.10...v1.0.0-beta.11>
