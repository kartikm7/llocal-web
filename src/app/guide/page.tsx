  ...
  return <div className="w-full h-full p-16 flex flex-col gap-5 justify-center items-center">
    <div className="w-3/5 text-xs lg:text-base space-y-2 md:space-y-5 mt-16">
      ...
      <ul className="space-y-2">
        ...
        <li>- There are some recommendations below the Pull a model section, but I feel a general consumer should have slightly more knowledge on what model is correct for them.<span className="text-blue-400"> If you are not interested and just want to get going, then pull phi3 or gemma:2b</span>.</li>
      ...
      <Separator className="" />
      <p className="">For more information regarding supported models you can check out: <Link href='https://www.ollama.com/library' target="_blank" className="text-blue-400 hover:underline transition-all">ollama.ai/library</Link> </p>
    </div>
